export type ListMarketsResponse = ApiMarket[];
...
export interface ApiMarket {
  ...
  score: number;
  imageOptimized: MediaOptimized;
  iconOptimized: MediaOptimized;
  events: Event[];
  categories: Category[];
  tags: Tag[];
  creator: string;
...
export interface MediaOptimized {
  id: string;
...
export interface Event {
  ...
  imageOptimized: MediaOptimized;
  iconOptimized: MediaOptimized;
  featuredImageOptimized: MediaOptimized;
  subEvents: string[];
...
export interface Series {
  ...
  cgAssetName: string;
  score: number;
  events: unknown[]; // shape not specified in sample
  collections: Collection[];
  categories: Category[];
  tags: Tag[];
  commentCount: number;
...
export interface Collection {
  ...
  imageOptimized: MediaOptimized;
  iconOptimized: MediaOptimized;
  headerImageOptimized: MediaOptimized;
}
